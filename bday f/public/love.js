(function(window){
    ...
    Bloom = function(tree, point, figure, color, alpha, angle, scale, place, speed) {
        this.tree = tree;
        this.point = point;
        this.color = color || ['rgb(255, 182, 193)', 'rgb(255, 192, 203)', 'rgb(255, 160, 122)', 'rgb(255, 218, 185)', 'rgb(255, 240, 245)'][random(0, 4)];
        this.alpha = alpha || random(0.5, 0.95);
        this.angle = angle || random(0, 360);
        this.scale = scale || 0.05;
        this.place = place;
        this.speed = speed;
        this.wobble = random(0, 360);
        this.figure = figure;
    }
    Bloom.prototype = {
        ...
        flower: function() {
            ...
            s.scale += 0.12;
            s.wobble += 0.1;
            s.alpha = Math.max(0.3, s.alpha - 0.01);
            if (s.scale > 1) {
        ...
        draw: function() {
            ...
            ctx.rotate(s.angle + Math.sin(s.wobble * 0.05) * 0.1);
            ctx.beginPath();
            ctx.moveTo(0, 0);
